...
namespace AyaMod.Content.Prefixes.CameraPrefixes.ExtraPrefixes
{
    ...
    {
        public virtual LocalizedText PrefixExtraTooltip { get; protected set; }

        public override void SetStaticDefaults()
        {
            PrefixExtraTooltip = Mod.GetLocalization($"{LocalizationCategory}.{this.GetType().Name}.{nameof(PrefixExtraTooltip)}");
        }
