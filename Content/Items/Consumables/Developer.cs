...
namespace AyaMod.Content.Items.Consumables
{
    public class Developer : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.SetShopValues(Terraria.Enums.ItemRarityColor.Orange3, Item.sellPrice(silver: 10));
            Item.buffType = BuffType<DevelopingBuff>();
        ...
        public override void AddRecipes()
        {
            CreateRecipe(3)
                ...
                .AddRecipeGroup("AyaMod:AnyDyeItem")
