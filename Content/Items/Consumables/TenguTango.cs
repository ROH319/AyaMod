...
{
    public class TenguTango : ModItem, IPlaceholderItem
    {
        public override string Texture => AssetDirectory.Consumables + Name;
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(SpeedBonus, DashBonus, SpeedDeduction);
        public static int SpeedBonus = 15;
        public static int DashBonus = 25;
        public static int SpeedDeduction = 10;
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = BuffType<TenguBuff>();
